...
[_LOWER] = {
  ...
  {KC_TILD, KC_EXLM,   KC_AT, KC_HASH, _______, _______, _______, KC_LCBR, KC_RCBR, KC_LPRN, KC_RPRN,  KC_DEL},
  {_______,  KC_DLR, KC_PERC, KC_CIRC, _______, _______, _______, KC_UNDS, KC_PLUS, KC_LBRC, KC_RBRC, _______},
  {_______, KC_AMPR, KC_ASTR, _______, _______, _______, _______, _______, _______, KC_LABK, KC_RABK, _______},
...
[_RAISE] = {
  ...
  { KC_GRV,    KC_1,    KC_2,    KC_3, _______, _______, _______, KC_BSLS, KC_PIPE, _______, _______,  KC_DEL},
  {_______,    KC_4,    KC_5,    KC_6, _______, _______, _______, KC_MINS,  KC_EQL, KC_LPRN, KC_RPRN, _______},
