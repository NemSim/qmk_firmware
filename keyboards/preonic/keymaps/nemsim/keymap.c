 ...
 */
[_LOWER] = {
  {KC_TILD, _______, _______, _______, _______, _______, _______,   KC_P7,   KC_P8,   KC_P9, KC_PSLS,  KC_DEL},
  {KC_PENT, _______, _______, _______, _______, KC_BSLS, _______,   KC_P4,   KC_P5,   KC_P6, KC_PAST, _______},
  {_______, KC_UNDS, KC_MINS, KC_PLUS,  KC_EQL, KC_PIPE, _______,   KC_P1,   KC_P2,   KC_P3, KC_PMNS, _______},
  {_______, _______, _______, _______, _______, _______, _______,   KC_P0, KC_PEQL, KC_PDOT, KC_PPLS, _______},
...
[_RAISE] = {
  ...
  {_______, _______, _______, KC_LCBR, KC_RCBR, _______, _______, KC_LPRN, KC_RPRN, _______, _______, _______},
  {_______, _______, _______, KC_LBRC, KC_RBRC, _______, KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, KC_COLN,  KC_DQT},
